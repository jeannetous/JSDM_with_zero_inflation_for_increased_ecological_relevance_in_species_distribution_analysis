...
############################ Reference ZI values from real data ################
##### SITES #####
# Stream-aggregated
...
block_values_ref <- matrix(c(0.7, 6.9, 6.1, 2.9,
                             -1.4, 6.9, -1.5, 0.4,
                             3.7, 2.9, 4.7, 6.9,
                             -3.1, -1.2, -3.2, 0.1,
                             -2.3, 4, 2.7, -3.2,
...
n_mode_zi_proba_sites_list = c(3, 3)
zi_mode_values_sites_list = list(zi_mode_values_stream_ref, zi_mode_values_site_ref)
proba_mode_zi_sites_list = list(proba_mode_zi_values_stream_ref, proba_mode_zi_values_site_ref)


n_mode_zi_proba_species_list = c(4)
...
block_values_list = list(block_values_ref) #, matrix(c(-10,-10, -10, 2,-10,0, -10,2,0), nrow = 3))
row_clusters_proba_list = list(row_clusters_proba_ref)#, c(0.4, 0.4, 0.2))
col_clusters_proba_list = list(col_clusters_proba_ref)#, c(0.75, 0.125, 0.125))
...
n = 300 ; p = 20 ; zi_type = "covar"; block_values = block_values_ref
...
simu_params = list(n = n,
                   ...
                   proba_mode_zi = zi_mode_values_species_ref,
                   ...
                   min_X0 = 0, max_X0 = 10,
                   max_X0B0 = 0.2)
res <- one_ZIPLN_simulation(1, "covar_1", simu_params,
